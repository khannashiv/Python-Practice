...
# This provides a simple way for users to see the contents of multiple directories in one run. One thing to note is that the code assumes the os module has already been imported; otherwise, it will raise a NameError. 
